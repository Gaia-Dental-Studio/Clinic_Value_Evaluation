...
percentage_profit = st.number_input("Percentage Profit (%)", value=40, step=5) if type == 'Percentage Profit' else 100
...
with col3:
    sell_percentage = st.number_input("Sell Percentage", value=50, min_value=0, step=10)
    reinvest_percentage = st.number_input("Reinvest Percentage", value=50, min_value
                                            =0, step=10)

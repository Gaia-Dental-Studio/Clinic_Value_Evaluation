from dummy_clinic_model.dummy_clinic_generator import DummyClinicModel
...
def app():
    ...
    reference_clinic_df = pd.read_csv('dummy_clinic_model/reference_clinic_df_real.csv')[:50]
    item_code_df = pd.read_csv("dummy_clinic_model/cleaned_item_code.csv")
    demand_prob_item_code = pd.read_csv("dummy_clinic_model/clarity_data_with_demand_prob.csv")
    ...
    with col1:
        ...
        clinic_metrics[selected_clinic]['updated_clinic_item_code'].to_csv('dummy_clinic_model/clinic_item_code.csv', index=False)
    ...
    def save_pickles_with_folder(dummy_clinic_df, clinic_metrics, item_code_per_clinic):
        ...
        parent_dir = "dummy_clinic_model/pkl_files"
    ...
    dataframe_gross_profit.to_csv('clinic_gross_profit.csv', index=False)
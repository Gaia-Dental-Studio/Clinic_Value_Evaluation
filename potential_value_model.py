...
def app():
    ...
    if calculate:
        ...
        with st.container(border=True):
            ...
            st.plotly_chart(model.summary_table(forecast_df_with_treatments, sliced_amortization_df, indirect_expense))
        ...
        with st.container(border=True):
            ...
            st.plotly_chart(model.summary_table(MA_forecast_df_with_treatments, sliced_amortization_df, indirect_expense))
